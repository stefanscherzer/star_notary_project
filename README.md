...
([project](https://github.com/udacity/nd1309-p2-Decentralized-Star-Notary-Service-Starter-Code))
and deployed it on the public Rinkeby testnet.
<br><br>
I used the following versions to run the project:<br>
Truffle version: v5.3.2<br>
OpenZeppelin version: v2.3
<br><br>
ERC-721 Token Name: <b>StarNotary Token</b><br>
ERC-721 Token Symbol: <b>SNTok</b><br>
...
5. Create a .secret and a .infurakey file in your root folder.<br>
...
# For migrating the contract to the Rinkeby Ethereum Testnet, inside the development console
